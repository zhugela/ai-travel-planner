...
### 3.4 工具生态（Spring AI 内置 + 第三方）

| 工具 | 来源 | 你项目现状 |
|------|------|----------|
| `MethodToolCallback` | Spring AI 内置 | ❌ 未用 |
| `@Tool` 注解 | Spring AI 内置 | ❌ 未用 |
| 网页抓取 | Hutool / jsoup | ❌ 未用 |
| PDF 生成 | iText | ❌ pom 有,**未用** |
| 联网搜索 | 第三方 API | ❌ 未用 |
| MCP Client | spring-ai-mcp | ❌ pom 有,**未用** |
